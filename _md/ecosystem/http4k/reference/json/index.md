...
- If you are using OpenAPI contracts and want complete reflective documentation for class instances, the only current option is to use **Jackson**. **Kondor** provides documentation for manually registered adapters.
