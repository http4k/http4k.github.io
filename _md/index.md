...
- **Highly extendable** - Supports many Server, Serverless and HTTP Client technologies behind simple, consistent interfaces. http4k provides [over 200 pre-built integrations](/ecosystem/) for developers to choose from including Observability, JSON, and OpenAPI support.
